...
class WorkerThread(threading.Thread):
    ...
    def __init__(self, requests_queue, results_queue, poll_timeout=5, stoppingCondition=lambda: False, **kwds):
...
class ThreadPool:
    ...
    def __init__(self, num_workers, q_size=0, resq_size=0, poll_timeout=5, stoppingCondition=lambda: False):
    ...
    def createWorkers(self, num_workers, poll_timeout=5):
        ...
        for i in range(num_workers):
            self.workers.append(WorkerThread(self._requests_queue,
                self._results_queue, poll_timeout=poll_timeout, stoppingCondition=self.stoppingCondition))
    ...
    def poll(self, block=False):
        ...
        while True:
            if self._stopped.isSet() or self.stoppingCondition(): ## I added
